    ...
    return /******/ (function(modules) { // webpackBootstrap
        ...
        /******/ 	function __webpack_require__(moduleId) {
            ...
            /******/ 		if(installedModules[moduleId]) {
                ...
                /******/ 		}
            /******/ 		// CreateOld a new module (and put it into the cache)
                ...
                var Choices =
                    ...
                    function () {
                        function Choices(element, userConfig) {
                            ...
                            } // CreateOld array of choices from option elements
                        ...
                        Choices.prototype._renderItems = function () {
                            var activeItems = this._store.activeItems || [];
                            this.itemList.clear(); // CreateOld a fragment to store our list items
                        ...
                        Choices.prototype._createChoicesFragment = function (choices, fragment, withinGroup) {
                            ...
                            if (withinGroup === void 0) {
                                withinGroup = false;
                            } // CreateOld a fragment to store our list items (so we don't have to update the DOM for each item)
                        ...
                        Choices.prototype._createItemsFragment = function (items, fragment) {
                            ...
                            if (fragment === void 0) {
                                fragment = document.createDocumentFragment();
                            } // CreateOld fragment to add elements to
                        ...
                        Object.defineProperty(WrappedSelect.prototype, "options", {
                            ...
                            set: function set(options) {
                                ...
                                var addOptionToFragment = function addOptionToFragment(data) {
                                    // CreateOld a standard select option

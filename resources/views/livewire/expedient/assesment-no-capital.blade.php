<div class="space-y-4">
    <x-card.card>
        <x-expedient.header :expedient="$expedient">
            {{__('Valoración de daños')}}
        </x-expedient.header>
    </x-card.card>
    ...
    <x-card.card class="divide-gray-200 divide-y">
        ...
        @include('partials.expedient.assessment.table_no_capital', ['subguaranteesUsed' => $expedient->subguaranteesUsed($person->id)])
    </x-card.card>

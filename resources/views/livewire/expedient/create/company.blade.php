<div class="w-full p-4 overflow-auto space-y-4">
    ...
    @if($openedStep == 1)
        <livewire:expedient.create.step1-company :expedient="$expedient" :key="'step1'.$expedient->id"/>
    @elseif($openedStep == 2)
        <livewire:expedient.create.step2-company :expedient="$expedient" :key="'step2'.$expedient->id"/>
    @elseif($openedStep == 3)

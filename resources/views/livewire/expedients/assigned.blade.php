...
{{--                    <x-button.primary wire:click="createParticular">--}}
{{--                        <div class="flex justify-between space-x-2">--}}
{{--                            <x-icon.plus size="4" /> <x-icon.users size="4" />--}}
{{--                        </div>--}}
{{--                    </x-button.primary>--}}
{{--                </div>--}}
{{--                <div class="flex-shrink-0">--}}
{{--                    <x-button.primary wire:click="createCompany">--}}
{{--                        <div class="flex justify-between space-x-2">--}}
{{--                            <x-icon.plus size="4" /> <x-icon.office-building size="4" />--}}
{{--                        </div>--}}
{{--                    </x-button.primary>--}}
{{--                </div>--}}
                <div class="flex-shrink-0">

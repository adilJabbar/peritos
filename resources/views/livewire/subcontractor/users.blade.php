                    ...
                    <x-table.row wire:loading.class.delay="opacity-50" wire:key="row-{{ $userRow->id }}">
                        ...
                        <x-table.cell>
                            <span class="inline-flex items-center text-xs font-medium capitalize">
                                     {{ $userRow->supervisor($subcontractor->gabinete)->full_name ?? '' }}
                            </span>
                        </x-table.cell>

                        <x-table.cell>
                            <span class="inline-flex items-center text-xs font-medium capitalize">
                                     {{ $userRow->backoffice($subcontractor->gabinete)->full_name ?? '' }}
                            </span>
                        </x-table.cell>

                        <x-table.cell noPadding>
                            <div class="flex justify-center">
                                @if($userRow->supervisedAdvances($subcontractor->gabinete))
                        ...
                        <x-table.cell noPadding>
                            <div class="flex justify-center">
                                @if($userRow->supervisedReports($subcontractor->gabinete))
                                    <x-icon.eye size="5" class="text-red-500" />
                                @else
                                    <x-icon.eye-off size="5" class="text-green-500" />
                                @endif
                        ...
                        <x-table.cell noPadding>
                            <div class="flex justify-center">
                                @if($userRow->supervisedIncidences($subcontractor->gabinete))
                                    <x-icon.eye size="5" class="text-red-500" />
                                @else
                                    <x-icon.eye-off size="5" class="text-green-500" />
                                @endif
                        ...
                        <x-table.cell noPadding>
                            <div class="flex justify-center">
                                @if($userRow->contactToCompany($subcontractor->gabinete))
